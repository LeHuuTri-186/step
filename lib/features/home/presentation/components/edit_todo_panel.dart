...
class EditTodoPanel extends StatefulWidget {
  EditTodoPanel({
    super.key,
  ...
  @override
  State<EditTodoPanel> createState() => _EditTodoPanelState();
}

class _EditTodoPanelState extends State<EditTodoPanel> {
  ...
  void initState() {
    super.initState();
    _todo = Todo.copy(widget.todo);

    _dueDate = _todo.dueDay;

    if (_todo.deadline != null) {
      _deadline = TimeOfDay(hour: _todo.deadline!.hour, minute: _todo.deadline!.minute);
    }
